 ...
 *
 * The server refuses to resolve a task while any step is outstanding, so
 * without this a maintainer holding a safety-critical work order on a phone
 * could open it and never close it.
 */
